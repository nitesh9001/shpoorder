...
class TermsAdd extends React.Component {
  ...
  onSave = () => {
    ...
    fetch(Constant.getAPI() + "/metadata/add/termsAndCondition", {
      method: "post",
      headers: {
      ...
      .then(function (json) {
        if (json.status == true) {
          Swal.fire("Updated !", "Term & Conditions has been Updated", "success");
  ...
  getRefundPolicy = () => {
    ...
    fetch(Constant.getAPI() + "/metadata/view/termsAndCondition", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
