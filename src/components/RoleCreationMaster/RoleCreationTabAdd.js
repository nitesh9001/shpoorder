...
import RoleCreationAdd from "./RoleCreationAdd";
class RoleCreationTabAdd extends React.Component {
  state = {
    language_id: "en",
  };
  ...
  componentDidMount() {
    if (
      ...
      console.log(this.props.match.params.role_id);
    }
              ...
              <div className="col-lg-8">
                <div className="page-header-title">
                  <div className="d-inline">
                    <h4>
                      {this.props.match.params.role_id ? "Edit" : "Add"} Role
                      Creation & Mapping
                    </h4>
                  </div>
                </div>
              ...
              <div className="col-lg-4">
                <div className="page-header-breadcrumb">
                  <ul className="breadcrumb-title">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="/brand">Role Creation List</Link>
                    </li>
...
RoleCreationTabAdd.propTypes = {
  getUsers: PropTypes.func.isRequired,
  login: PropTypes.object.isRequired,
  error: PropTypes.object.isRequired,
};
export default connect(mapStateToProps, {})(RoleCreationTabAdd);
