    ...
    orders_list: [
      {
        id: 1,
        Customer_id: "c-id1",
        customerPincode: "380001",
        customerName: "Customer 1",
        customerPhone: "78xxxxxx0",
        orderID: "orde-123",
        sellerid: "SEL_123",
    ...
    const columns = [
      ...
      },
      {
        ...
        options: {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.likesFilter) {
                return [`Min: ${v[0]}`, `Max: ${v[1]}`];
              } else if (v[0] && v[1] && !this.state.likesFilter) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              } else if (v[0]) {
                return `Min: ${v[0]}`;
              } else if (v[1]) {
          ...
          filterOptions: {
            ...
            display: (filterList, onChange, index, column) => (
              <div>
                <FormLabel style={{ fontSize: "12px" }}>Likes</FormLabel>
                <FormGroup row>
                  <TextField
                    label="min"
      ...
      },
      {
        ...
        options: {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.disLikesFilter) {
                return [`Min: ${v[0]}`, `Max: ${v[1]}`];
              } else if (v[0] && v[1] && !this.state.disLikesFilter) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              } else if (v[0]) {
                return `Min: ${v[0]}`;
              } else if (v[1]) {
          ...
          filterOptions: {
            ...
            display: (filterList, onChange, index, column) => (
              <div>
                <FormLabel style={{ fontSize: "12px" }}>Dislikes</FormLabel>
                <FormGroup row>
                  <TextField
                    label="min"
                    value={filterList[index][0] || ""}
                ...
                <div className="col-lg-8">
                  <div className="page-header-title">
                    <div className="d-inline">
                      <h4>Consumer Feedback Report</h4>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="card-block">
                      ...
                      <div className="dt-responsive table-responsive">
                        <MuiThemeProvider theme={this.getMuiTheme()}>
                          <MUIDataTable
                          title={"Consumer Feedback Report"}
...
export default ConsumerFeedbackReport;
