...
class CouponUsageReport extends Component {
  state = {
    ...
    downdata: [],
    checked: false,
    totalAmountofPurchaseFilter: false,
    discountAmountFilter: false,
    purchasedOnFilter: false,
    setDateWise:null,
    CouponUsageReports: [
      {
        id: 1,
        ...
        orderId: "MFO-12345-12345-12345-17112020",
        sellerId: "AhmSI38002712345",
        customer_id: "cust-im123",
        totalAmountofPurchase: "3216",
        discountAmount: "500",
        purchasedOn: "2020-10-7",
        status: "completed",
      },
    ],
  };
    ...
    const columns = [
      ...
      },
      {
        ...
        options: {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.totalAmountofPurchaseFilter) {
                return [`Min: ${v[0]}`, `Max: ${v[1]}`];
              } else if (
                v[0] &&
                v[1] &&
                !this.state.totalAmountofPurchaseFilter
              ) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              } else if (v[0]) {
                return `Min: ${v[0]}`;
      ...
      },
      {
        ...
        options: {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.discountAmountFilter) {
                return [`Min: ${v[0]}`, `Max: ${v[1]}`];
              } else if (v[0] && v[1] && !this.state.discountAmountFilter) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              } else if (v[0]) {
                return `Min: ${v[0]}`;
              } else if (v[1]) {
      ...
      },
      {
        ...
        options: {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.purchasedOnFilter) {
                return [`Min: ${v[0]}`, `Max: ${v[1]}`];
              } else if (v[0] && v[1] && !this.state.purchasedOnFilter) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              }
              return [];
            },
                    ...
                    <div className="row">
                      ...
                      <div className="dt-responsive table-responsive">
                          ...
                          <MUIDataTable
                            ...
                            data={this.state.CouponUsageReports}
                            columns={columns}
                            options={options}
                          />
                        </MuiThemeProvider>
