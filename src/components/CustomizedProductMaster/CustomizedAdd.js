...
class CustomizedAdd extends React.Component {
  state = {
    status: "Active",
    ...
    id: 1,
    name: "Tea",
    longDescription: 'Our service centers',
    price: '125KD',
    sku: 'ED1420',
  ...
  getProductDetails = () => {
    ...
    fetch(Constant.getAPI() + "/product/get", {
      ...
      if (json.status === true) {
        ...
        if (json.result[0].Attributes !== null && json.result[0].Attributes !== [] && json.result[0].Attributes.length > 0) {
          for (var i = 0; i < json.result[0].Attributes.length; i++) {
            selected_attributes.push(json.result[0].Attributes[i].id);
            $("#product_attributes_" + json.result[0].Attributes[i].id).prop("checked", true)
          }
        }
  ...
  updateCategoryData = (media_id) => {
    ...
    if (that.state.CategoryId === undefined || that.state.CategoryId === null || that.state.CategoryId === "" || that.state.CategoryId === "0") {
      Swal.fire("Warning !", "Please Select Product Category First. !", "warning");
      ...
      <div className="">
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="form-group row">
                <label className="col-sm-3 col-form-label">Functions</label>
                <div className="col-sm-9">
                  <input
                    type="text"
                    className="form-control"
            ...
            <div className="col-md-6">
              <div className="form-group row">
                <label className="col-sm-3 col-form-label">Dimensions</label>
                <div className="col-sm-9">
                  <input
                    type="text"
                    className="form-control"
            ...
            <div className="col-md-6">
              <div className="form-group row">
                <label className="col-sm-3 col-form-label">Crystal</label>
                <div className="col-sm-9">
                  <input
                    type="text"
                    className="form-control"
            ...
            <div className="col-md-6">
              <div className="form-group row">
                <label className="col-sm-3 col-form-label">Caseback</label>
                <div className="col-sm-9">
                  <input
                    type="text"
                    className="form-control"
                    name="caseback"
                    id="caseback"
                    placeholder="Caseback"
                    onChange={this.handleChange}
                    value={this.state.caseback}
                  />
                </div>
              </div>
            </div>
            <div className="col-md-6">
              <div className="form-group row">
                <label className="col-sm-3 col-form-label">Dial</label>
                <div className="col-sm-9">
                  <input
                    type="text"
                    className="form-control"
