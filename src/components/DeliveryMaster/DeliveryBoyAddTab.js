              ...
              <div className="col-lg-4">
                <div className="page-header-breadcrumb">
                  <ul className="breadcrumb-title">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="/delivery-boy-list">Delivery Boy</Link>
                    </li>
                  ...
                  <div className="card-block">
                        ...
                        ? this.state.language_data.map((language) => (
                            ...
                            >
                              <a
                                ...
                                data-toggle="tab"
                                href={"#tyre_Delivery Boy Add_" + language.id}
                                role="tab"
                                aria-controls={"tyre_Delivery Boy Add_" + language.id}
                                aria-selected="true"
                              >
                                {language.name}{" "}
                              </a>
                    ...
                    <div className="tab-content tabs">
                      <div
                        ...
                        id={"tyre_Delivery Boy Add_" + this.state.language_id}
                        role="tabpanel"
                        aria-labelledby=""
                      >
                        {this.state.deliveryboy_id !== undefined &&
                        this.state.deliveryboy_id !== null &&
                        this.state.deliveryboy_id !== 0 &&
                        this.state.deliveryboy_id !== "" ? (
                          <DeliveryBoyAdd
                            language_id={this.state.language_id}
                            goBack={this.props.history.goBack}
                            deliveryboy_id={this.state.deliveryboy_id}
                          />
                        ) : (
                          <DeliveryBoyAdd
                            language_id={this.state.language_id}
