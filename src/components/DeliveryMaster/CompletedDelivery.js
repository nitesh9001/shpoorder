...
import { createMuiTheme, MuiThemeProvider } from "@material-ui/core/styles";import { Tooltip, Button,FormLabel,
  FormGroup,TextField,
  Select ,FormControl,InputLabel} from "@material-ui/core";
...
class CompletedDelivery extends React.Component {
  state = {
    open: false,
    hidedownload: false,
    hideOld: false,
...
CompletedDelivery.propTypes = {
  getUsers: PropTypes.func.isRequired,
  login: PropTypes.object.isRequired,
  error: PropTypes.object.isRequired,
};
export default connect(mapStateToProps, {})(CompletedDelivery);
