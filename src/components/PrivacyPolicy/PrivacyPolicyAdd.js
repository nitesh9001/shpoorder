...
class PrivacyPolicyAdd extends React.Component {
  ...
  onSave = () => {
    ...
    fetch(Constant.getAPI() + "/metadata/add/privacyPolicy", {
      method: "post",
      headers: {
      ...
      .then(function (json) {
        if (json.status == true) {
          Swal.fire("Updated !", "Privacy Policy has been Updated", "success");
  ...
  getRefundPolicy = () => {
    ...
    fetch(Constant.getAPI() + "/metadata/view/privacyPolicy", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
