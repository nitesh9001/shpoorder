...
class UserSellerList extends React.Component {
  state = {open: false,
    hideOld: false,
    ...
    fetch(Constant.getAPI() + "/users/list", {
      ...
      .then(function (json) {
        if (json.status === true) {
          ...
          that.setState({ UsersellerList: json.data });
        } else {
          that.setState({ UsersellerList: [] });
          Swal.fire({
  ...
  handleChange = (e, id) => {
    ...
    let newArray = this.state.UsersellerList.filter((d) => {
      // console.log(d)
                  ...
                  <div className="col">
                    ...
                    <div className="dt-responsive table-responsive">
                      <MuiThemeProvider theme={this.getMuiTheme()}>
                        ...
                        data={this.state.UsersellerList}
                        columns={columns}
                        options={options}
                      />
                        </MuiThemeProvider>
