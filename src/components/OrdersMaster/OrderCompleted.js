    ...
    orders_list: [
      {
        ...
        genrateInvoice: "76754-3676363-25515",
      },
    ],
  };
  componentWillMount() {
    ...
    const columns = [
      ...
      // },
      {
        ...
        options: {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.dateOfCompletitionFilter) {
                return [`Min: ${v[0]}`, `Max: ${v[1]}`];
              } else if (v[0] && v[1] && !this.state.dateOfCompletitionFilter) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              }
              return [];
            },
      ...
      },
      {
        ...
        options: {
          filter: true,
          sort: false,
          customBodyRender: (genrateInvoice, tabelMeta) => {
            return (
              <Link
                to="/invoice"
