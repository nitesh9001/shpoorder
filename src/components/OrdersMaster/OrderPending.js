    ...
    orders_list: [
      {
        ...
        assignDateofDelivery: "2020-10-27",
        ...
        sendNotification: "1424GsN Invoice",
        genrateInvoice: "hbdy7374",
      },
    ],
  };
  componentWillMount() {
          ...
          customFilterListOptions: {
            render: (v) => {
              if (v[0] && v[1] && this.state.assignDateofDeliveryFilter) {
                ...
                v[0] &&
                v[1] &&
                !this.state.assignDateofDeliveryFilter
              ) {
                return `Min: ${v[0]}, Max: ${v[1]}`;
              }
              return [];
          ...
          filterOptions: {
            logic(assignDateofDelivery, filters) {
              if (filters[0] && filters[1]) {
                ...
                //  var date2 = new Date(arrEndDate[2], arrEndDate[1], arrEndDate[0])
                return (
                  assignDateofDelivery < filters[0] ||
                  assignDateofDelivery > filters[1]
                );
              } else if (filters[0]) {
